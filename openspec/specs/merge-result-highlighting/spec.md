# Spec: Merge Result Highlighting

## Scope

This spec defines the visual highlighting, gutter glyph, scroll-to-change, and chevron icon behaviors in the Merge Result editor and Select Changes panel. It covers hover-driven background highlights, persistent gutter decorations for handled/unhandled state, click-to-scroll navigation, directional chevron indicators, and decoration recomputation.
